...
/***/ function(module, exports, __webpack_require__) {
	...
	function connect(mapStateToProps, mapDispatchToProps) {
	  ...
	  return function wrapWithConnect(pageConfig) {
        ...
        if (this.route !== currentPage.route) return
        ...
        if (mappedState === this.prevState) return
      ...
      function onShow(options) {
	    ...
	    return (0, _Object.assign)({}, pageConfig, mapDispatch(app.store.dispatch), { onLoad: onLoad, onShow: onShow, onUnload: onUnload });
	  };
	}
